...
class Alexa extends Command
{
     ...
     * @var string
     */
    protected $signature = 'blog:alexa_ranker';
     ...
     * @var string
     */
    protected $description = 'Blog siteleri için alexa durumunu kontrol eder.';
    ...
    {
        $crawlers = BlogCrawler::where('test', true)
            ...
            foreach ($crawlers as $crawler)
            {
                ...
                catch (\Exception $e)
                {
                    ...
                    System::log(
                        ...
                        'App\Console\Commands\Crawlers\Blog\Alexa::create('.$crawler->id.')',
                        10
                    );
                }
            }
