		...
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<p class="white-text">@lang('string.header.lead-1')</p>
					<p class="grey-text">@lang('string.header.lead-2')</p>
					<p class="grey-text">@lang('string.header.lead-3')</p>

					<a href="#" class="waves-effect btn black-text white">Giriş Yapın</a>
	...
	<div class="container">
		...
		<div class="item-group" id="features">
			<div class="item white-text">
				...
				<h5>Analiz</h5>
				<ul>
					<li>Twitter etkileşim raporu.</li>
			...
			<div class="item white-text">
				...
				<ul>
					...
					<li>Twitter ve Yerli Medya anahtar kelime alarmı.</li>
				</ul>
			</div>
			<div class="item white-text">
...
<div class="parallax-container">
	...
	<div class="container">
			...
			<div class="card-content grey lighten-4">
				<div id="tab0">
					...
					<ul class="collection collection-unstyled collection-unstyled-hover">
				    	...
				    	<li class="collection-item">
				    		<div class="grey-text">
				    			Twitter ve Yerli Medya anahtar kelime alarmı.
				    			<i class="material-icons secondary-content red-text">close</i>
				    		</div>
				    	</li>
				    	<li class="collection-item">
		...
		<div class="center-align">
			<a href="#" class="waves-effect btn white black-text btn-large">Hemen Başlayın!</a>
		</div>
	</div>
</div>
@endsection
