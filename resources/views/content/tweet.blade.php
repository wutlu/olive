    ...
    <div class="row">
        <div class="col m12 xl6">
            <div class="card">
                <div class="card-content">
                    <span class="card-title">Kullanıcının Sık Kullandığı Kelimeler</span>
                    @if (@$data['keywords'])
        ...
        <div class="col m12 xl6">
            @include('content._inc.sentiment', [
                ...
                'alert' => 'İlgili kullanıcının toplam '.$data['total']->data['count'].' tweet\'e alındı. Sayfadaki istatistik verileri alınan tweetler üzerinden gerçekleştirilmiştir.'
            ])
        </div>
        <div class="col m12 xl12">
            <div class="card">
                <div class="card-content">
                    <div class="markdown">
                    	...
                    	{!! Term::markdown($document['_source']['text']) !!}
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-content cyan">
                    <span class="card-title white-text mb-0">Kullanıcının Diğer Tweetleri</span>
                </div>
