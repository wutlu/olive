...
@section('wildcard')
    <div class="card">
        <div class="container container-wide">
            <div
                ...
                data-method="post"
                data-timeout="4000"
                data-href="{{ route('crawlers.blog.bot.statistics.all') }}"
    ...
    <ul id="more" class="dropdown-content">
        <li>
            <a class="waves-effect" href="{{ route('crawlers.blog.bot') }}">Yeni Bot</a>
        </li>
        <li>
            <a
                href="#"
                ...
                data-href="{{ route('crawlers.blog.bot.start.all') }}"
        ...
        <li>
            <a
                ...
                data-trigger="trigger"
                data-href="{{ route('crawlers.blog.bot.stop.all') }}"
        ...
        <li>
            <a
                ...
                data-trigger="trigger"
                data-href="{{ route('crawlers.blog.bot.clear.all') }}"
...
@section('dock')
    @include('crawlers.blog._menu', [ 'active' => 'list' ])
    ...
    <div class="card card-unstyled">
        ...
        <div class="collection collection-unstyled">
            ...
            <label class="collection-item waves-effect d-block">
                ...
                <span>İçerik Sayısı (Artan)</span>
            </label>
            <label class="collection-item waves-effect d-block">
                <input name="sort" id="sort-hit-down" type="radio" value="hit-down" />
                <span>İçerik Sayısı (Azalan)</span>
            </label>
            <label class="collection-item waves-effect d-block">
...
@section('content')
    <div class="card with-bg">
        ...
        <div class="collection load json-clear"
             id="crawlers"
             data-method="post"
             data-href="{{ route('crawlers.blog.list.json') }}"
             data-skip="0"
             data-take="50"
            ...
            <a
                ...
                <span class="right-align">
                    ...
                    <p class="grey-text mb-0">
                        <span data-name="index"></span> içerik alındı
                    </p>
                    <p class="grey-text mb-0">
