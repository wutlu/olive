    ...
    <div class="col xl4 l5 s12">
        ...
        <div class="card">
            <div class="card-image">
                <img src="{{ asset('img/md/9.jpg') }}" alt="" />
                <span class="card-title">Organizasyon Oluşturun</span>
            </div>
            <div class="card-content">
                <p class="grey-text">Tüm modüllerden faydalanabilmek için hemen bir organizasyon oluşturun.</p>
            </div>
        ...
        <div class="card">
            <div class="card-image">
                ...
                <span class="card-title">veri.zone</span>
            ...
            <div class="card-content">
                <p class="grey-text">2/8 kullanıcı</p>
            </div>
            <div class="collection">
                <a href="#" class="collection-item avatar waves-effect">
                    <img src="{{ auth()->user()->avatar() }}" alt="" class="circle">
                    <span class="title">Alper Mutlu TOKSÖZ</span>
                    <p>alper@veri.zone</p>
                    <p class="grey-text">Organizasyon Sahibi</p>
                </a>
                <a href="#" class="collection-item avatar waves-effect">
                    <img src="{{ auth()->user()->avatar() }}" alt="" class="circle">
                    <span class="title">Canberk Eraslan</span>
                    <p>canberk@veri.zone</p>
                    <p class="grey-text">Kullanıcı</p>
                </a>
            </div>
        </div>
    	@endif
