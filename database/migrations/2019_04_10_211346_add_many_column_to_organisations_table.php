...
class AddManyColumnToOrganisationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('organisations', function (Blueprint $table) {
            ...
            $table->unsignedInteger('data_pool_youtube_channel_limit')->default(100);
            $table->unsignedInteger('data_pool_youtube_video_limit')->default(100);
            $table->unsignedInteger('data_pool_youtube_keyword_limit')->default(100);
            $table->unsignedInteger('data_pool_twitter_keyword_limit')->default(400);
            $table->unsignedInteger('data_pool_twitter_user_limit')->default(5000);
            $table->unsignedInteger('data_pool_facebook_keyword_limit')->default(400);
            $table->unsignedInteger('data_pool_facebook_user_limit')->default(5000);
            $table->unsignedInteger('data_pool_instagram_keyword_limit')->default(400);
            $table->unsignedInteger('data_pool_instagram_user_limit')->default(5000);

            $table->unsignedSmallInteger('historical_days')->default(30);
        });
    }
