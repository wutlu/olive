    ...
    public function run()
    {
        $items = [
            ...
            [
                ...
                'base' => 'turkce',
                'url_pattern' => '(\b(?!gettyimages|-))([a-z0-9-]{10,128})-(\d{8,9})',
            ...
            [
                ...
                'base' => '/',
                'url_pattern' => '(\b(?!video))([a-z0-9-]{4,24})\/([a-z0-9-]{4,128})_(\d{6,9})',
            ...
            [
                ...
                'selector_title' => '.art-head > h1',
                'selector_description' => '.art-head > .art-excerpt',
                'control_interval' => 15,
                'control_date' => '2018-09-01 23:54:07',
                'test' => true,
            ],
